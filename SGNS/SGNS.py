...
# write = SummaryWriter("runs/SGNS")


class DataReader:
    NEGATIVE_TABLE_SIZE = 1e8

    def __init__(self, inputFileName, labelFileName, min_count, care_type):
                ...
                if len(words) > 1:
                    ...
                    for i, u in enumerate(word_ids):
                        for j, v in enumerate(
                            ...
                            pair_catch.append(
                                (u, v, self.data.getNegatives(v, self.neg_num)))
                    return pair_catch
...
class SGNSTrainer:
    ...
    def __init__(self, args):  # , g_hin):
        # min_cont & care_type
        self.data = DataReader(args.walk_file, args.label_file, 0, 0)
    ...
    def train(self):
        ...
        # for para in self.skip_gram_model.parameters():
        #     print('in 285:', para)
        ...
        for epoch in range(self.epochs):
            ...
            for i, sample_batched in enumerate(self.dataloader):
                ...
                if len(sample_batched[0]) > 1:
                    ...
                    n += 1
            print("\nepoch:" + str(epoch) + " Loss: " + str(epoch_loss / n), datetime.datetime.now())
            self.skip_gram_model.eva_embedding(self.data.word2id, self.label, self.n_label)
